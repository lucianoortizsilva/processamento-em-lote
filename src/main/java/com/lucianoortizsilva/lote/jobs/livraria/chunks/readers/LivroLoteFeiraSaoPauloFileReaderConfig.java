...
@Configuration
public class LivroLoteFeiraSaoPauloFileReaderConfig {

	@Bean
	FlatFileItemReader<LivroDTO> livroLoteFeiraSaoPauloFileReader() {
		return new FlatFileItemReaderBuilder<LivroDTO>()//
				.name("livroLoteFeiraSaoPauloFileReader")//
				.resource(new FileSystemResource("arquivos/livros_lote_feira_sao_paulo.csv"))//
				.delimited().delimiter(",")//
				.names(getNames())//
